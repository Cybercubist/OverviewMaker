...
def calculate_k(likelihood_dict1, likelihood_dict2, emotion_array):
    ...
    k2 = (likelihood_dict2['uptrend']*0 + likelihood_dict2['downtrend']*(-1) + likelihood_dict2['upburst']*0.4 +
    ...
    + likelihood_dict2['down_and_up']*1 + likelihood_dict2['up_and_down']*(-0.4)) / 100
